...
/** 
 * DAO for table "FAVORITE_CATEGORY".
*/
public class FavoriteCategoryDao extends AbstractDao<FavoriteCategory, Long> {
    ...
    /**
     * Properties of entity FavoriteCategory.<br/>
    ...
    */
    ...
    public FavoriteCategoryDao(DaoConfig config) {
        super(config);
    }
    
    public FavoriteCategoryDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FAVORITE_CATEGORY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FAVORITE_CATEGORY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, FavoriteCategory entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public FavoriteCategory readEntity(Cursor cursor, int offset) {
        FavoriteCategory entity = new FavoriteCategory( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, FavoriteCategory entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(FavoriteCategory entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(FavoriteCategory entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
