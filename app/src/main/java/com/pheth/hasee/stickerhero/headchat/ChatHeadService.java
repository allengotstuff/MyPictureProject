...
//		Utils.getCurrentRunningActivity(getApplicationContext());

		FlurryAgent.logEvent(StaticConstant.HERO_HEAD_CHAT_CLICK);

			Log.e("ChatHeadService","chatHead_click");
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if(intent != null){
			...
			if(bd != null)
				...
				if(bd.getBoolean(Utils.START_HEADCHAT,false)){
					if(!isHeadShow) {
						handleStart();
					}
				}
